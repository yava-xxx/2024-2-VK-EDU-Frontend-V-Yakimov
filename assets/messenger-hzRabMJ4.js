import{c as o,u as C,s as E}from"./chats-kHMLDPK4.js";import{g as w,a as L,b as y,c as b,d as $}from"./utils-BuyREcAV.js";let v=w();const U=L(v),I=o.getChatsForUser(U.id),k=i=>{if(window.innerWidth<1400)window.location.href=`../chat_page/chat.html?chatId=${i}`;else{const a=document.getElementById("chat-page"),f=`
